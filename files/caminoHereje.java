...
{   
    ...
    public static void caminoArco(jugador player , int dificultad)
    {
        ...
        files.printTexto.textoEfectoEscritura("No es sangre lo que corre en mis venas,\n" + //
