...
public class caminoDestruccion
{
    ...
    public static void FinalDestruccion(jugador player, int dificultad, boolean finalAlternativo)
    {
        ...
        files.printCositas.textoEfectoEscritura("Tras la batalla consigues hacer caer a Yax-Balam, tu arma está quebrada y la única salida que tienes es portar su bastón y golpear su cabeza mientras intenta reincorporarse a la batalla.\r\n" + //
                          "\r\n" + //
    ...
    public static void monedaAcertijo(jugador player, int dificultad)
    {
        ...
        files.printCositas.textoEfectoEscritura(
